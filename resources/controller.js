...
request.open('GET', './db/db.json', false)
request.send(null)
const dbObj = JSON.parse(request.responseText)
console.log(dbObj)
...
// const imgFillRowNew = function (container, firstID, numOfImgInRow) {
// 	for (let i = firstID; i <= numOfImgInRow; i++) {
// 		galleryContainter.insertAdjacentHTML(
// 			'beforeend',
// 			`<div class="gallery__img"><img src="./resources/images/numbered/${imgNameNr}.jpg" alt=${description}></div>`
// 		)
// 	}
